    ...
    <footer>
      <div>
        ...
        <div className={styles.social_icons}>
          <a href="https://www.devmountain.com" target="_blank" className={styles.social_icons_container}>
            <ImFacebook size="1.5em" color="#2D3047" />
          </a>
          <a href="https://www.devmountain.com" target="_blank" className={styles.social_icons_container}>
            <ImInstagram size="1.5em" color="#2D3047" />
          </a>
          <a href="https://www.devmountain.com" target="_blank" className={styles.social_icons_container}>
            <ImTwitter size="1.5em" color="#2D3047" />
          </a>
          <a href="https://www.devmountain.com" target="_blank" className={styles.social_icons_container}>
            <ImGithub size="1.5em" color="#2D3047" />
          </a>
        </div>
      </div>
      <svg
